...
export default function Block({ data }) {
  let blockDetail = data ? data.blockDetail : null;
  return (
    <Grid item xs={12}>
      <Paper
        sx={{
          ...
          <Table>
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell>
                  Mined {blockDetail.timePassed} ago (@{" "}
              ...
              <TableRow>
                ...
                <TableCell>
                  🔥
                  {Utils.formatEther(
                    toBigNumber(blockDetail.baseFeePerGas).mul(
                      blockDetail.gasUsed
                    )
                  )}{" "}
                  ETH (
...
export async function getServerSideProps({ params, req, res }) {
  ...
  const data = {
    blockDetail: {
      ...
      timePassed: formatAgeInSeconds(b.timestamp),
      miner: b.miner,
      gasLimit: plainBigNumber(b.gasLimit),
      gasUsed: plainBigNumber(b.gasUsed),
      baseFeePerGas: plainBigNumber(b.baseFeePerGas),
      _difficulty: plainBigNumber(b._difficulty),
    },
  };
